...
it('throws exception if svg dimensions are missing', function () {
    $merger = new SvgMerger('<svg>content</svg>', 'image data', 0.2);
    $merger->merge();
...
it('throws exception if merged image data is invalid', function () {
    $merger = new SvgMerger('<svg width="100" height="100"></svg>', 'invalid image data', 0.2);
    $merger->merge();
...
it('throws exception if svg closing tag is missing', function () {
    ...
    $merger = new SvgMerger('<svg width="100" height="100">', $validImage, 0.2);
    $merger->merge();
