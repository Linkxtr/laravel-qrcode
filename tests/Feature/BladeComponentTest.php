...
it('renders a qr code component with eye colors', function () {
    $blade_string = '<x-qr-code data="https://example.com" eye-color0="#ff0000, #00ff00" eye-color1="#0000ff" eye-color2="#000000" />';
    $rendered = Blade::render($blade_string);
    expect($rendered)->toContain('<svg');
});
...
it('renders a qr code component with merge string', function () {
    ...
    $component = new \Linkxtr\QrCode\Components\QrCodeComponent('https://example.com', 100, 'svg', mergeString: $imgData, mergePercentage: .3);
