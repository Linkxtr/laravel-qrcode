...
2- Ask me for a confirmation on the plan before start the implementaion.
3- TDD Approach: following the TDD approach in implementation: write Pest tests according to `testing-standards.md`, then write the PHP code following `strict-typing.md`.
